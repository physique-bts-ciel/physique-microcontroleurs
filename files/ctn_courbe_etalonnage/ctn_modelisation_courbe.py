...
plt.text(32,20E3,r'$R = R_0 \times e^{\beta(\frac{1}{T+273.15}-\frac{1}{25+273.15})}$', size='xx-large', backgroundcolor="white")
plt.text(32,18E3,r'$\beta\approx3290\rm~K$   ', size='large', backgroundcolor="white")
plt.text(32,16E3,r'$R_0\approx10,4\rm~k\Omega$', size='large', backgroundcolor="white")
plt.legend()
